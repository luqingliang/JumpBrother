...
generateEUI.paths['resource/scene/BeginScene.exml'] = window.BeginSceneSkin = (function (_super) {
	...
	function GameSceneSkin() {
		_super.call(this);
		this.skinParts = ["lab_huiHe","img_bg","blockPanel","btn_reStart","lab_overScore","GameOverPanel"];
	...
	_proto._Group1_i = function () {
		...
		t.right = 0;
		t.top = 0;
		t.elementsContent = [this._Image1_i(),this.lab_huiHe_i()];
		return t;
	};
	_proto._Image1_i = function () {
		var t = new eui.Image();
	...
	_proto.GameOverPanel_i = function () {
		...
		t.top = 0;
		t.visible = false;
		t.elementsContent = [this._Rect1_i(),this.btn_reStart_i(),this._Label1_i(),this._Label2_i(),this.lab_overScore_i()];
		return t;
	};
